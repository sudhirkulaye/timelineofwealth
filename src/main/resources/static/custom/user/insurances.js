var incExpSavingsModule = angular.module('InsurancesManagement', []);

incExpSavingsModule.controller('InsurancesController', function($scope, $http, $filter) {
    ...
    $scope.insuranceForm = {
        ...
        "lastDatePremiumPaid":new Date("2010-01-01"),
        "lifeTimeCover":"No",
    ...
    $scope.editInsuranceRecord = function editInsuranceRecord(insuranceRecord){
        ...
        $scope.insuranceForm.lastDatePremiumPaid = new Date(insuranceRecord.lastDatePremiumPaid);
    ...
    $scope.showClearForm = function showClearForm() {
        ...
        $scope.insuranceForm.lastDatePremiumPaid = new Date("2018-01-01");
