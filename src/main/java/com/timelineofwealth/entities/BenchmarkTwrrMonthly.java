...
@Entity
@Table(name = "benchmark_twrr_monthly")
public class BenchmarkTwrrMonthly implements Serializable {
    @Embeddable
    public static class BenchmarkTwrrMonthlyKey implements Serializable {
    ...
    @EmbeddedId
    private BenchmarkTwrrMonthlyKey key;
    ...
    public BenchmarkTwrrMonthlyKey getKey() {
        return key;
    }
    public void setKey(BenchmarkTwrrMonthlyKey key) {
        this.key = key;
    }
