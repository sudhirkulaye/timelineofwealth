...
CREATE TABLE asset_classification (
  ...
  asset_class_group varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'XXX' COMMENT 'Group for Asset classes',
...
CREATE TABLE benchmark_twrr_monthly (
  ...
  KEY index_benchmark_twrr_monthly_memberid (benchmarkid)
...
CREATE TABLE bse_price_history (
  bse_ticker varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT 'PK BSE Code',
  ...
  KEY index_bse_price_history_date (date),
  KEY index_bse_price_history_bse_ticker (bse_ticker)
...
CREATE TABLE composite (
  ...
  fund_manager_email varchar(50) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Name of the Fund Manager',
...
CREATE TABLE daily_data_b (
  ticker_b varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT 'Bloomberg code for the stock',
  ...
  KEY index_daily_data_b_date (date)
...
CREATE TABLE daily_data_s (
  ...
  net_profit decimal(20,3) DEFAULT '0.000',
  sales decimal(20,3) DEFAULT '0.000',
  fcf_s decimal(20,3) DEFAULT '0.000',
  yoy_quarterly_sales_growth decimal(10,4) DEFAULT '0.0000',
  yoy_quarterly_profit_growth decimal(10,4) DEFAULT '0.0000',
  qoq_sales_growth decimal(10,4) DEFAULT '0.0000',
  qoq_profit_growth decimal(10,4) DEFAULT '0.0000',
  opm_latest_quarter decimal(10,4) DEFAULT '0.0000',
  opm_last_year decimal(10,4) DEFAULT '0.0000',
  npm_latest_quarter decimal(10,4) DEFAULT '0.0000',
  npm_last_year decimal(10,4) DEFAULT '0.0000',
  profit_growth_3years decimal(10,4) DEFAULT '0.0000',
  sales_growth_3years decimal(10,4) DEFAULT '0.0000',
  sales_growth_5years decimal(10,4) DEFAULT '0.0000',
  sales_growth_10years decimal(10,4) DEFAULT '0.0000',
  pe_ttm decimal(10,3) DEFAULT '0.000',
  historical_pe_3years decimal(10,3) DEFAULT '0.000',
  peg_ratio decimal(10,3) DEFAULT '0.000',
  pb_ttm decimal(10,3) DEFAULT '0.000',
  ev_to_ebit decimal(10,3) DEFAULT '0.000',
  dividend_payout decimal(10,4) DEFAULT '0.0000',
  roce decimal(10,4) DEFAULT '0.0000',
  roe decimal(10,4) DEFAULT '0.0000',
  avg_roce_3years decimal(10,4) DEFAULT '0.0000',
  avg_roe_3years decimal(10,4) DEFAULT '0.0000',
  debt decimal(20,3) DEFAULT '0.000',
  debt_to_equity decimal(10,3) DEFAULT '0.000',
  debt_3years_back decimal(20,3) DEFAULT '0.000',
  mcap_to_netprofit decimal(10,3) DEFAULT '0.000',
  mcap_to_sales decimal(10,3) DEFAULT '0.000',
  noplat decimal(20,3) DEFAULT '0.000',
  capex decimal(20,3) DEFAULT '0.000',
  fcff decimal(20,3) DEFAULT '0.000',
  invested_capital decimal(20,3) DEFAULT '0.000',
  roic decimal(10,4) DEFAULT '0.0000',
  ...
  return_1D decimal(10,4) DEFAULT '0.0000',
  return_1W decimal(10,4) DEFAULT '0.0000',
  return_1M decimal(10,4) DEFAULT '0.0000',
  return_3M decimal(10,4) DEFAULT '0.0000',
  return_6M decimal(10,4) DEFAULT '0.0000',
  return_1Y decimal(10,4) DEFAULT '0.0000',
  up_52w_min decimal(10,4) DEFAULT '0.0000',
  down_52w_max decimal(10,4) DEFAULT '0.0000',
  volume_1D decimal(20,0) DEFAULT NULL,
  volume_1W decimal(20,0) DEFAULT NULL,
  dma_50 decimal(20,3) DEFAULT '0.000',
  dma_200 decimal(20,3) DEFAULT '0.000',
  rsi decimal(10,4) DEFAULT '0.0000',
  total_assets decimal(10,3) DEFAULT '0.000',
  net_block decimal(10,3) DEFAULT '0.000',
  working_capital decimal(10,3) DEFAULT '0.000',
  inventory decimal(10,3) DEFAULT '0.000',
  trade_receivables decimal(10,3) DEFAULT '0.000',
  trade_payables decimal(10,3) DEFAULT '0.000',
  shares_outstanding_cr decimal(10,3) DEFAULT '0.000',
  PRIMARY KEY (date,name),
  KEY index_daily_data_s_date (date),
  KEY index_daily_data_s_name (name)
...
CREATE TABLE daily_data_s_bkp (
  ...
  invested_capital decimal(20,3) DEFAULT '0.000',
  roic decimal(10,4) DEFAULT '0.0000',
  sector varchar(50) DEFAULT 'NA',
  industry varchar(100) DEFAULT 'NA',
  sub_industry varchar(100) DEFAULT 'NA'
...
CREATE TABLE income_expense_savings (
  ...
  adjustment decimal(20,3) DEFAULT '0.000' COMMENT 'Mismatch',
  note varchar(100) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Related comment',
...
CREATE TABLE index_monthly_returns (
  ...
  jan_return decimal(10,4) DEFAULT '0.0000' COMMENT 'January Return',
  feb_return decimal(10,4) DEFAULT '0.0000' COMMENT 'February Return',
  mar_return decimal(10,4) DEFAULT '0.0000' COMMENT 'March Return',
  apr_return decimal(10,4) DEFAULT '0.0000' COMMENT 'April Return',
  may_return decimal(10,4) DEFAULT '0.0000' COMMENT 'May Return',
  jun_return decimal(10,4) DEFAULT '0.0000' COMMENT 'June Return',
  jul_return decimal(10,4) DEFAULT '0.0000' COMMENT 'July Return',
  aug_return decimal(10,4) DEFAULT '0.0000' COMMENT 'August Return',
  sep_return decimal(10,4) DEFAULT '0.0000' COMMENT 'September Return',
  oct_return decimal(10,4) DEFAULT '0.0000' COMMENT 'October Return',
  nov_return decimal(10,4) DEFAULT '0.0000' COMMENT 'November Return',
  dec_return decimal(10,4) DEFAULT '0.0000' COMMENT 'December Return',
  annual_return decimal(10,4) DEFAULT NULL COMMENT 'Annual Return',
...
CREATE TABLE index_valuation (
  ...
  KEY index_index_valuation_ticker (ticker),
  KEY index_index_valuation_date (date)
...
CREATE TABLE insurance (
  ...
  last_date_of_premium date NOT NULL COMMENT 'Prmeium last payment date',
...
CREATE TABLE liability (
  ...
  loan_desc varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Loan Description',
  ...
  current_emi_day varchar(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Current EMI day of the month',
  last_emi_month varchar(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Last EMI month',
  last_emi_year varchar(4) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Last EMI year',
  ...
  active_status varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Active' COMMENT 'Current Active Status: Active or Fully Paid',
  date_last_update date NOT NULL COMMENT 'Date when record last updated',
...
CREATE TABLE liquidity (
  ...
  frequency int(2) NOT NULL COMMENT 'Maturity Frequency: 0 - One Time, 1 - Annually, 2: Semiannually, 4: Quarterly,  12: Monthly, 24: Fortnightly, 52: Weekly, 250: Daily',
...
CREATE TABLE mosl_transaction (
  ...
  quantity decimal(20,3) DEFAULT '0.000' COMMENT 'Quantity',
  rate decimal(20,4) DEFAULT '0.0000' COMMENT 'Buy Rate',
  amount decimal(20,3) DEFAULT '0.000' COMMENT 'Amount = quantity x rate',
  brokerage decimal(20,3) DEFAULT '0.000' COMMENT 'Brokerage',
  txn_charges decimal(20,3) DEFAULT '0.000' COMMENT 'Transaction Charges',
  service_tax decimal(20,3) DEFAULT '0.000' COMMENT 'Service Charges',
  stamp_duty decimal(20,3) DEFAULT '0.000' COMMENT 'Stamp Duty Charges',
  stt_ctt decimal(20,3) DEFAULT '0.000' COMMENT 'STT CTT Charges',
  net_rate decimal(20,4) DEFAULT '0.0000' COMMENT 'Net Rate',
  net_amount decimal(20,3) DEFAULT '0.000' COMMENT 'Net Amount',
  ...
  is_processed varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'N' COMMENT 'Y/N for is Processed',
  portfolioid int(3) NOT NULL DEFAULT '1',
  PRIMARY KEY (moslcode,date,script_name,sell_buy,order_no,trade_no,portfolioid),
  KEY index_mosl_transaction_date (date),
  KEY index_mosl_transaction_script_name (script_name),
  KEY index_mosl_transaction_moslcode (moslcode)
...
CREATE TABLE mutual_fund_nav_history (
  ...
  KEY index_mutual_fund_nav_history_date (date),
  KEY index_mutual_fund_nav_history_scheme_code (scheme_code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='BSE Daily Price History';

CREATE TABLE mutual_fund_stats (
  scheme_code int(15) NOT NULL COMMENT 'PK Mutual Fund Scheme Code Unique',
  scheme_name_part varchar(1000) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Mutual Fund Scheme Short Name',
...
CREATE TABLE mutual_fund_universe (
  ...
  scheme_code_direct_growth int(15) DEFAULT NULL COMMENT 'Scheme Code for Direct Growth',
  scheme_code_regular_growth int(15) DEFAULT NULL COMMENT 'Scheme Code for Regular Growth',
  ...
  dividend_freq varchar(10) COLLATE utf8_unicode_ci DEFAULT '-' COMMENT 'Dividend freq. Monthly, Quaterly, Annual, Bonus, Flexible Etc.',
  ...
  debt_style_box varchar(50) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Mutual Fund Debt Style Box: High-Mid-Low Credit Quality Vs High-Medium-Low Duration',
...
CREATE TABLE nse_price_history (
  ...
  KEY index_nse_price_history_date (date),
  KEY index_nse_price_history_nse_ticker (nse_ticker)
...
CREATE TABLE portfolio (
  ...
  net_investment decimal(20,3) DEFAULT '0.000' COMMENT 'Net Cash-inflow',
  market_value decimal(20,3) DEFAULT '0.000' COMMENT 'Market value of the portfolio',
  holding_period decimal(7,3) DEFAULT '0.000' COMMENT 'Holding period in years i.e. Start date to till date',
  net_profit decimal(20,3) DEFAULT '0.000' COMMENT 'Unrealized Net Profit = Market Value - Net Investment',
  absolute_return decimal(20,4) DEFAULT '0.0000' COMMENT 'Absolute Returns',
  annualized_return decimal(20,4) DEFAULT '0.0000' COMMENT 'Annualized Returns XIRR',
  PRIMARY KEY (memberid,portfolioid),
  KEY index_portfolio_memberid (memberid)
...
CREATE TABLE portfolio_asset_allocation (
  ...
  KEY index_portfolio_asset_allocation_memberid (memberid),
  KEY index_portfolio_asset_allocation_date (date)
...
CREATE TABLE portfolio_cashflow (
  ...
  description varchar(500) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Cashflow Description',
  PRIMARY KEY (memberid,portfolioid,date),
  KEY index_portfolio_cashflow_memberid (memberid),
  KEY index_portfolio_cashflow_date (date)
...
CREATE TABLE portfolio_historical_holdings (
  ...
  KEY index_portfolio_historical_holdings_memberid (memberid)
...
CREATE TABLE portfolio_holdings (
  ...
  KEY index_portfolio_holdings_memberid (memberid)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE portfolio_returns_calculation_support (
  ...
  description varchar(500) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'Cashflow Description',
  PRIMARY KEY (memberid,portfolioid,date),
  KEY index_portfolio_returns_calculation_support_memberid (memberid)
...
CREATE TABLE portfolio_twrr_monthly (
  ...
  KEY index_portfolio_twrr_monthly_memberid (memberid)
...
CREATE TABLE portfolio_twrr_summary (
  ...
  KEY index_portfolio_twrr_summary_memberid (memberid)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Portfolio - TWRR (Time Weighted Rate of Returns) Summary';
...
CREATE TABLE portfolio_value_history (
  ...
  PRIMARY KEY (memberid,portfolioid,date),
  KEY index_portfolio_value_history_memberid (memberid),
  KEY index_portfolio_value_history_date (date)
...
CREATE TABLE sip (
  ...
  KEY index_sip_memberid (memberid)
...
CREATE TABLE sip_process_log (
  ...
  PRIMARY KEY (memberid,sipid),
  KEY index_sip_process_log_memberid (memberid)
...
CREATE TABLE sip_process_msg_log (
  ...
  KEY index_sip_process_msg_log_date (date),
  KEY index_sip_process_msg_log_memberid (memberid)
...
CREATE TABLE stock_balancesheet (
  ...
  KEY index_stock_balancesheet_ticker (ticker),
  KEY index_stock_balancesheetr_date (date)
...
CREATE TABLE stock_cashflow (
  ...
  PRIMARY KEY (ticker,cons_standalone,date),
  KEY index_stock_cashflow_ticker (ticker),
  KEY index_stock_cashflow_date (date)
...
CREATE TABLE stock_pnl (
  ...
  ebitda_g_3yr decimal(10,4) DEFAULT '0.0000' COMMENT '3 Years EBITDA growth',
  ebitda_g_5yr decimal(10,4) DEFAULT '0.0000' COMMENT '5 Years EBITDA growth',
  ebitda_g_10yr decimal(10,4) DEFAULT '0.0000' COMMENT '10 Years EBITDA growth',
  ...
  PRIMARY KEY (ticker,cons_standalone,date),
  KEY index_stock_pnl_ticker (ticker),
  KEY index_stock_pnl_date (date)
...
CREATE TABLE stock_price_movement (
  ...
  up_52w_min decimal(10,4) DEFAULT NULL COMMENT 'Up from 52-Week Min Price',
  ...
  1w_min decimal(20,3) DEFAULT '0.000' COMMENT '1 Week Min Price',
  1w_max decimal(20,3) DEFAULT '0.000' COMMENT '1 Week Max Price',
  2w_min decimal(20,3) DEFAULT '0.000' COMMENT '2 Week Min Price',
  2w_max decimal(20,3) DEFAULT '0.000' COMMENT '2 Week Max Price',
  1m_min decimal(20,3) DEFAULT '0.000' COMMENT '1 Month Min Price',
  1m_max decimal(20,3) DEFAULT '0.000' COMMENT '1 Month Max Price',
  2m_min decimal(20,3) DEFAULT '0.000' COMMENT '2 Month Min Price',
  2m_max decimal(20,3) DEFAULT '0.000' COMMENT '2 Month Max Price',
  3m_min decimal(20,3) DEFAULT '0.000' COMMENT '3 Month Min Price',
  3m_max decimal(20,3) DEFAULT '0.000' COMMENT '3 Month Max Price',
  6m_min decimal(20,3) DEFAULT '0.000' COMMENT '6 Month Min Price',
  6m_max decimal(20,3) DEFAULT '0.000' COMMENT '6 Month Max Price',
  PRIMARY KEY (ticker),
  KEY index_stock_price_movement_ticker (ticker)
...
CREATE TABLE stock_price_movement_history (
  ...
  KEY index_stock_price_movement_history_ticker (ticker),
  KEY index_stock_price_movement_history_date (date)
...
CREATE TABLE stock_quarter (
  ...
  result_date date DEFAULT NULL COMMENT 'Quarter result date',
  PRIMARY KEY (ticker,cons_standalone,date),
  KEY index_stock_quarter_ticker (ticker),
  KEY index_stock_quarter_date (date)
...
CREATE TABLE stock_universe (
  ...
  KEY ticker5 (ticker5),
  KEY ticker2 (ticker2),
  KEY index_stock_universe_ticker (ticker),
  KEY index_stock_universe_ticker2 (ticker2),
  KEY index_stock_universe_ticker3 (ticker3),
  KEY index_stock_universe_ticker5 (ticker5)
...
CREATE TABLE stock_valuation (
  ...
  wacc decimal(10,4) DEFAULT '0.0000' COMMENT 'Weighted Avg. Cost of Capital',
  tax_rate decimal(10,4) DEFAULT '0.0000' COMMENT 'Tax Rate',
  revenue_growth_next_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'Revenue growth for Next 10 Yr',
  opm_next_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'OPM or EBITDA Margin for next 10 year',
  net_ppe_by_revenue_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'Net PP&E by Revenue for next 10 year',
  depreciation_by_net_ppe_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'Net PP&E by Revenue for next 10 year',
  other_inc_growth_next_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'Other Inc. growth for Next 10 Yr',
  other_inc_growth_period decimal(10,4) DEFAULT '0.0000' COMMENT 'Other Inc. growth period',
  other_inc_terminal_growth decimal(10,4) DEFAULT '0.0000' COMMENT 'Other Inc. terminal growth rate',
  other_inc_by_investment decimal(10,4) DEFAULT '0.0000' COMMENT 'Other Inc. by investment',
  historical_roic decimal(10,4) DEFAULT '0.0000' COMMENT 'Historical Return on Capital',
  ronic decimal(10,4) DEFAULT '0.0000' COMMENT 'Return on New Invested Capital',
  next_stage_growth_period decimal(10,4) DEFAULT '0.0000' COMMENT 'Next stage growth period',
  revenue_growth_second_stage decimal(10,4) DEFAULT '0.0000' COMMENT 'Revenue growth for second stage',
  roic_second_stage decimal(10,4) DEFAULT '0.0000' COMMENT 'Return on New Invested Capital',
  terminal_growth decimal(10,4) DEFAULT '0.0000' COMMENT 'Revenue terminal growth rate',
  terminal_roic decimal(10,4) DEFAULT '0.0000' COMMENT 'Terminal ROIC rate',
  mcap decimal(20,3) DEFAULT '0.000' COMMENT 'Market Cap at the time of valuation',
  price decimal(20,3) DEFAULT '0.000' COMMENT 'Market price at the time of valuation ',
  min_fair_price decimal(20,3) DEFAULT '0.000' COMMENT 'Minimum Fair Price of stock',
  max_fair_price decimal(20,3) DEFAULT '0.000' COMMENT 'Maximum Fair Price of stock',
  ...
  min_revenue_growth_next_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'Min. Revenue growth for Next 10 Yr for min. price',
  max_revenue_growth_next_10yr decimal(10,4) DEFAULT '0.0000' COMMENT 'Max. Revenue growth for Next 10 Yr for min. price',
  min_mcap decimal(20,3) DEFAULT '0.000' COMMENT 'Min. Market Cap for min. price',
  max_mcap decimal(20,3) DEFAULT '0.000' COMMENT 'Max. Market Cap for min. price',
  actual_min_price decimal(20,3) DEFAULT '0.000' COMMENT 'Minimum Fair Value',
  actual_max_price decimal(20,3) DEFAULT '0.000' COMMENT 'Maximum Fair Value',
  actual_min_mcap decimal(20,3) DEFAULT '0.000' COMMENT 'Actual Min. Market Cap for the quarter',
  actual_max_mcap decimal(20,3) DEFAULT '0.000' COMMENT 'Actual Max. Market Cap for the quarter',
...
CREATE TABLE user (
  ...
  last_login_time datetime DEFAULT '2000-01-01 00:00:00' COMMENT 'Last login timestamp',
...
CREATE TABLE wealth_asset_allocation_history (
  ...
  KEY index_wealth_asset_allocation_history_memberid (memberid),
  KEY index_wealth_asset_allocation_history_date (date)
...
CREATE TABLE wealth_details (
  ...
  maturity_date date DEFAULT '1900-01-01' COMMENT 'Security Maturity Value especially for FDs',
  last_valuation_date date DEFAULT '1900-01-01' COMMENT 'Last Valution Date',
  sipid int(2) DEFAULT '0' COMMENT 'SIP ID for automatic transaction',
  portfoliono varchar(45) COLLATE utf8_unicode_ci DEFAULT '0' COMMENT 'Portfolio Number in case of Mutual Fund',
  PRIMARY KEY (memberid,ticker,buy_date),
  KEY index_wealth_details_memberid (memberid)
...
CREATE TABLE wealth_history (
  memberid int(11) NOT NULL COMMENT 'PK member ID unique Auto Generated',
  date date NOT NULL COMMENT 'Date ',
  value decimal(20,4) DEFAULT NULL COMMENT 'Portfolio market value related to date',
  PRIMARY KEY (memberid,date),
  KEY index_wealth_history_memberid (memberid),
  KEY index_wealth_history_date (date)
